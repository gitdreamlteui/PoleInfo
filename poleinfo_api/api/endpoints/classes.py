...
from models.classes import get_all_classes, delete_classe
...
def delete_classes_endpoint(classe: ClasseDelete, user_id: int = Depends(verify_token)):
    ...
    result = delete_classe(classe.nom)
